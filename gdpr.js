if (getCookie('gdpr-accepted') !== 'true') {
    createStyles()
    createHTML()
...
function createHTML() {
    ...
    gdprText.innerText = 'Мы применяем cookie для наилучшего представления нашего сайта. Продолжая использовать сайт, вы подтверждаете свое согласие на использование куки.'
